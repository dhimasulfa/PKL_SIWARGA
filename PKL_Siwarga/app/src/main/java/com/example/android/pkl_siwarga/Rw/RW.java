package com.example.android.pkl_siwarga.Rw;
...
public class RW extends AppCompatActivity implements SearchView.OnQueryTextListener {
...
//    public static final String url_data = "http://192.168.1.12/siwarga/datarw.php";
    public static final String url_cari = "http://192.168.1.15/siwarga/carirw.php";

    private static final String TAG = RW.class.getSimpleName();

    public static final String TAG_ID = "id_rw";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipe = (SwipeRefreshLayout) findViewById(R.id.swipe_refresh_rw);
        list_view = (ListView) findViewById(R.id.list_view_rw);

        adapter = new Adapter(RW.this, listData);
...
//                Toast.makeText(RW.this, error.getMessage(), Toast.LENGTH_LONG).show();
//                swipe.setRefreshing(false);
//            }
//        });
//
...
//    }
    ...
    private void cariData(final String keyword) {
        pDialog = new ProgressDialog(RW.this);
