package com.example.android.pkl_siwarga.Rw.adapter;
...
import com.example.android.pkl_siwarga.Rw.model.DataModel;
...
public class Adapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
            convertView = inflater.inflate(R.layout.list_item_rw, null);
